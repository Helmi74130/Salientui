<?php
/**
 * Template pour l'élément Sparkle Glow Button
 * Affiche un bouton avec effet sparkle et bordures tournantes
 *
 ...
 * @var boolean $show_sparkle Afficher l'icône sparkle
...
<<?php echo esc_attr( $tag ); ?> class="<?php echo esc_attr( $classes ); ?>"
  ...
  <div class="salient-ui-sgb-dots-border"></div>

  <?php if ( $show_sparkle ) : ?>
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="salient-ui-sgb-sparkle"
    aria-hidden="true">
    <path class="salient-ui-sgb-path" stroke-linejoin="round" stroke-linecap="round"
  ...
  <span class="salient-ui-sgb-text"><?php echo esc_html( $text ); ?></span>
